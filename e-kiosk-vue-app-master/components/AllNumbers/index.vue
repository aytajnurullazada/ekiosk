<template>
  <div class="auth-box">
    ...
    <div class="head-title" >
      <Typography tag="p"><span v-if="data && data[0]">{{data ? data[0].name + ' - ' : ''}}</span> Bütün nömrələr</Typography>
    </div>
      ...
      <div class="col-auth">
        <div class="auth-content-box">
          ...
          <Pagination
            ...
            :filter="filters"
             action="all-numbers/fetchAllNumbers"
...
export default {
  ...
  props: {
   ...
   computed: {
    getPagination() {
      return this.$store.getters["all-numbers/getPagination"];
    },
  },
   methods: {
    getFilter(event) {
      ...
      let filterData = {};
      event.numberModel ? (filterData["number"] = event.numberModel.key) : false;
      ...
      this.$store.dispatch("all-numbers/fetchAllNumbers", {
        push: false,
