        ...
        <div class="auth-content-box">
          <div class="content-title">
           ...
           <div class="content-desc">
            <Typography tag="p">Şifrənizin sıfırlanması üçün zəhmət olmasa qeydiyyatdan keçdiyiniz e-malinizi daxil edin. “Göndər” düyməsinə klik etdikdən sonra e-mailinizə link göndəriləcək. Həmin linkə klik etməklə yeni şifrənizi daxil edə bilərsiniz</Typography>
          </div>
          <div class="input-items">
            <div class="item-input">
              <InputHolder v-model="email" typeHolder="text" label="Email" />
            </div>
